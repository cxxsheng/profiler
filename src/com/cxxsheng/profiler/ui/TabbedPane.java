...
import com.cxxsheng.profiler.ui.tracearea.ProcessOperationPanel;
...
public class TabbedPane extends JTabbedPane {
  ...
  public void showProcess(JProcess obj) {
      final ContentPanel contentPanel = getContentPanel(obj);
      if (contentPanel == null) {
        return;
      }
      SwingUtilities.invokeLater(() -> setSelectedComponent(contentPanel));
  ...
  public void showTrace(JTrace trace){
    final  ContentPanel contentPanel = getContentPanel(trace);
    if (contentPanel == null)
      return;
    SwingUtilities.invokeLater(() -> setSelectedComponent(contentPanel));
  }
  ...
  private ContentPanel makeContentPanel(JNode node) {
    if (node instanceof JProcess) {
      return new ProcessOperationPanel(this, node);
    }
    if (node instanceof JTrace) {
      return new TraceContentPanel(this, node);
    }
    return null;
  }
