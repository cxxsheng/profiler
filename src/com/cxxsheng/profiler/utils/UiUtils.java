...
public class UiUtils {
  ...
  public static ImageIcon openIconTest(String name) {
    String iconPath = "/icons/" + name + ".png";
    URL resource = UiUtils.class.getResource(iconPath);
    if (resource == null) {
      throw new ProfilerRuntimeException("Icon not found: " + iconPath);
    }
  ...
  public static Image openImage(String path) {
    ...
    if (resource == null) {
      throw new ProfilerRuntimeException("Image not found: " + path);
    }
